...
export const me = css({
  ...
  // When the image is wrapped (e.g., in a motion.div), apply the same sizing
  '& > div > img': {
    width: { xs: '10rem', xl: '25rem' },
    paddingTop: { xs: '6.25rem' }
  },
  // Nudge the image wrapper slightly to the right on large screens
  '& > div:first-of-type': {
    mr: { xl: '-2rem', '2xl': '-3.5rem' },
  },
  '& > div': {
